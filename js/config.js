  ...
  window.APP_CONFIG = {
    ...
    game: {
      ...
      wobble: {
        ...
        // 参考動画のゼリーは粘性が高く、着地で大きく潰れてから「揺り返しなしに」戻る。
        // 弾性の「ぷるん」を出すなら stiffness 0.045 / damping 0.965。
        stiffness: 0.06,         // 復元力。小さいほど大きくゆっくり戻る
        damping: 0.78,           // 速度の減衰(毎ステップの倍率)。低いほど揺り返さず粘る（過減衰）
        spread: 0.22,            // 隣へ伝わる量。大きいと波が回って揺り返しに見える
        ...
        squashScale: 0.02,       // 動画のブロックは落下中ほぼ矩形のまま。伸びは控えめ
        squashMax: 0.15
      },
